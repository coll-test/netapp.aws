...
class TestMyModule(unittest.TestCase):
    ...
    @patch('ansible_collections.netapp.ontap.plugins.module_utils.netapp.AwsCvsRestAPI.get_state')
    @patch('ansible_collections.netapp.ontap.plugins.module_utils.netapp.AwsCvsRestAPI.post')
    ...
    @patch('ansible_collections.netapp.ontap.plugins.module_utils.netapp.AwsCvsRestAPI.get_state')
    @patch('ansible_collections.netapp.ontap.plugins.module_utils.netapp.AwsCvsRestAPI.delete')
